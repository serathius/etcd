...
func TestTransportSend(t *testing.T) {
	...
	wmsgsIgnored := []*raftpb.Message{
		// bad local message
		{Type: new(raftpb.MsgBeat)},
		// bad remote message
		{Type: new(raftpb.MsgProp), To: new(uint64(3))},
	}
	wmsgsTo1 := []*raftpb.Message{
		// good message
		{Type: new(raftpb.MsgProp), To: new(uint64(1))},
		{Type: new(raftpb.MsgApp), To: new(uint64(1))},
	}
	wmsgsTo2 := []*raftpb.Message{
		// good message
		{Type: new(raftpb.MsgProp), To: new(uint64(2))},
		{Type: new(raftpb.MsgApp), To: new(uint64(2))},
	}
