...
func TestSendMessage(t *testing.T) {
	...
	tests := []*raftpb.Message{
		...
		{Type: new(raftpb.MsgProp), From: new(uint64(1)), To: new(uint64(2)), Entries: []*raftpb.Entry{{Data: data}}},
		{Type: new(raftpb.MsgApp), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Index: new(uint64(3)), LogTerm: new(uint64(0)), Entries: []*raftpb.Entry{{Index: new(uint64(4)), Term: new(uint64(1)), Data: data}}, Commit: new(uint64(3))},
		{Type: new(raftpb.MsgAppResp), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Index: new(uint64(3))},
		{Type: new(raftpb.MsgVote), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Index: new(uint64(3)), LogTerm: new(uint64(0))},
		{Type: new(raftpb.MsgVoteResp), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1))},
		{Type: new(raftpb.MsgSnap), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Snapshot: &raftpb.Snapshot{Metadata: &raftpb.SnapshotMetadata{Index: new(uint64(1000)), Term: new(uint64(1))}, Data: data}},
		{Type: new(raftpb.MsgHeartbeat), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Commit: new(uint64(3))},
		{Type: new(raftpb.MsgHeartbeatResp), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1))},
	}
...
func TestSendMessageWhenStreamIsBroken(t *testing.T) {
	...
	for {
		...
		case <-time.After(time.Millisecond):
			n++
			tr.Send([]*raftpb.Message{{Type: new(raftpb.MsgHeartbeat), From: new(uint64(1)), To: new(uint64(2)), Term: new(uint64(1)), Commit: new(uint64(3))}})
		case <-recvc:
			if n > 50 {
